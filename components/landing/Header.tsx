                ...
                <div className="mx-auto flex max-w-6xl items-center justify-center px-4 md:px-6">
                    <div className="glass-panel relative flex h-16 w-full items-center justify-between rounded-2xl px-4 md:px-6">
                        ...
                        <button
                            ...
                            className="flex h-12 w-12 items-center justify-center rounded-xl border border-white/15 bg-white/5 text-white shadow-lg ring-2 ring-brand-400/60 transition hover:-translate-y-0.5 hover:border-white/30 hover:bg-white/10 md:hidden"
                        >
                    ...
                    >
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                className="group flex h-12 w-12 items-center justify-center rounded-xl border border-amber-300/90 bg-white/5 text-white shadow-lg ring-2 ring-amber-300/70 transition hover:scale-[1.02] hover:border-amber-200"
                            >
                        ...
                        <div className="mt-12 flex justify-center">
                            <Button
                                asChild
                                size="lg"
                                className="h-12 min-w-[180px] rounded-2xl border border-white/15 bg-[#0b172d] text-base font-semibold text-white shadow-lg shadow-black/40 ring-1 ring-white/10 transition hover:-translate-y-0.5 hover:border-white/25 hover:bg-[#0d1c38]"
                            >
