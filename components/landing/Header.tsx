...
export default function Header() {
    return (
        <header className="fixed top-6 left-0 right-0 z-50 mx-auto max-w-5xl px-4 md:px-6">
            <div className="
                relative flex h-14 items-center justify-between rounded-full px-4
            ...
            ">
                <Link href="/" className="flex items-center gap-2">
                    <ShieldCheck className="h-6 w-6 text-indigo-600 dark:text-indigo-400 drop-shadow-[0_2px_4px_rgba(79,70,229,0.3)]" />
                ...
                <nav className="hidden items-center gap-6 md:flex">
                    <Link
                        href="#features"
                        className="text-sm font-medium text-zinc-800/80 hover:text-indigo-600 dark:text-zinc-200/80 dark:hover:text-indigo-400 transition-colors"
                    >
                        Features
                    </Link>
                    <Link
